...
interface FuturesTradingLayoutProps {
  selectedPair: string;
}

export default function FuturesTradingLayout({ selectedPair }: FuturesTradingLayoutProps) {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 max-h-[600px]">
      ...
      <div className="lg:col-span-2 space-y-6">
        {/* Trading Header */}
        <div className="flex items-center justify-between flex-wrap gap-4 p-4 bg-slate-900 rounded-lg border-slate-700">
